...
# Problem 2 Part 3: You need to implement the RMSprop optimizer.
class RMSprop:
    """RMSprop optimizer"""
    ...
    def update(self, grad_W, grad_b):
        ### Update rule for RMSprop, use the right update rules (the structure is similar to Adam/SGDmomentum)
